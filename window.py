...
def display_gravity_object(g_object, canvas):
    create_circle(g_object.position[0], g_object.position[1], OBJECT_RADIUS, canvas, 'g_object', 'white')


def display_all_gravity_objects(g_objects, canvas):
    for g_obj in g_objects:
        create_circle(g_obj.position[0], g_obj.position[1], OBJECT_RADIUS, canvas, 'g_object', 'white')
