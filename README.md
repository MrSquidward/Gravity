# Gravity
Gravity is GUI application wrote in Python with TKinter library by two students of WUT in their free time. It simulate movement of objects under the action of gravity force. User can specyfiy number of objects as well as starting position, mass and velocity of them.
# GUI
